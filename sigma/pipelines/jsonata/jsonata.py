...
@Pipeline
def jsonata_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="jsonata example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"jsonata_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="jsonata_field_mapping",
